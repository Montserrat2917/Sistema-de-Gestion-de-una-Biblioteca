...
<head>
    <meta charset="UTF-8">
    <title>Registro de Alumnos - Biblioteca</title>
    <link rel="stylesheet" href="alta_alumno.css">
    <style>
        .mensaje {
            padding: 12px;
            margin: 15px 0;
            ...
            <div class="alta-alumno">
                ...
                <form action="procesar_alumno.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="correo_electronico" name="correo_electronico" class="campo-texto" 
                               required>
                    </div>
                    
                    <div class="form-actions">
                        <input type="submit" value="Registrar Alumno" class="boton-enviar">
                    </div>
                </form>
            </div>
        </div>
