...
<head>
    <meta charset="UTF-8">
    <title>Profesor - Biblioteca</title>
    ...
    <div class="main-window">
        ...
        <div class="sidebar"> 
            ...
            <a href="alta_profesores.php" class="menu-link">
                <div class="menu-item"> 
                    <img src="img/agregar-usuario.png" alt="Profesor" class="menu-icon">
                    <span>Altas</span>
                </div>
            </a>
            ...
            <a href="consulta_profesor.php" class="menu-link">
                <div class="menu-item">
                    <img src="img/consulta.png" alt="Profesor" class="menu-icon">
            ...
            <a href="admin_dashboard.php" class="regresar">
                <div class="menu-item">
                    <img src="img/atras.png" alt="Profesor" class="menu-icon">
                    <span>Regresar</span>
                </div>
            </a>
